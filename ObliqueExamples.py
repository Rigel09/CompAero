...
if __name__ == "__main__":
    ...
    flow = OSR(1.4, shockAngle=43, wedgeAngle=22)
    # print(flow)
    ...
    flow = OSR(1.4, po2_po1=0.76, shockAngle=42)
    # print(flow)
