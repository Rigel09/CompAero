    ...
    def __str__(self) -> str:
        ...
        return "".join(
            [
                ...
                to_string("P0/P0*", self.po_poSt, self._preciscion),
                to_string("U/U*", self.u_uSt, self._preciscion, dot_line=True),
                to_string("T0/T0*", self.to_toSt, self.precision),
                to_string("Flow Type", self.flowType.name, self._preciscion, dot_line=True),
                seperator(),
                named_subheader("Pipe Parameters"),
                to_string("Heat Req. For Chocked Flow", self.chokedHeat, self._preciscion),
                color,
                to_string("Is Flow Choked? ", self.chockedFlow, self._preciscion, dot_line=True),
                to_string("Added Heat", self.heat, self._preciscion),
                to_string("Gas Constant R", self.gasConstantR, self._preciscion, dot_line=True),
                to_string("Cp", self.cp, self._preciscion),
                ...
                to_string("T0/T0*", self.to_toSt, self._preciscion, dot_line=True),
                ...
                to_string("T02/T01", self.to2_to1, self._preciscion),
