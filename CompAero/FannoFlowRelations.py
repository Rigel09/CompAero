    ...
    def __str__(self) -> str:
        ...
        return "".join(
            [
                ...
                value_to_string("4FL*/D", self.f4LSt_D, self._preciscion),
                ...
                value_to_string("Friction Coefficient", self.frictionCoeff, self._preciscion),
                seperator(),
                ...
                value_to_string("4FL*/D", self.dwnStrm_f4LSt_D, self._preciscion, dot_line=True),
